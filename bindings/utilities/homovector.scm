...
(define-structure snow-u8vect
                ;; uid: snow-u8vect-70c9ad92-1af6-4510-9505-89819df4ea9d
                str)

(define (snow-make-u8v n #!optional (fill 0))
...
(define-structure snow-u16vect
                ;; uid: snow-u16vect-3df9ca2a-9810-4c14-b2db-3969557a875a
                u8vect)

(define (snow-make-u16v n #!optional (fill 0))
